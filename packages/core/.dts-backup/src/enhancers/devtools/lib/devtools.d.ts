...
export declare function enableDevTools<T>(treeName?: string): (
  tree: SignalTree<T>
) => SignalTree<T> & {
  __devTools: ModularDevToolsInterface<T>;
};
export declare function withFullDevTools<T>(treeName?: string): (
  tree: SignalTree<T>
) => SignalTree<T> & {
  __devTools: ModularDevToolsInterface<T>;
};
export declare function withProductionDevTools<T>(): (
  tree: SignalTree<T>
) => SignalTree<T> & {
  __devTools: ModularDevToolsInterface<T>;
};
