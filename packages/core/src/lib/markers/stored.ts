...
} from './stored.contract';

// Identity, descriptor shape and the type guard live in the framework-neutral
// contract module; this file owns the Angular realization and every persistence
// consequence. Re-exported so the public surface is unchanged by the split.
export {
  STORED_MARKER,
  isStoredMarker,
} from './stored.contract';
