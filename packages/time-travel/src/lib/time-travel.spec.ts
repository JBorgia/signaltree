...
describe('Time Travel', () => {
  ...
  describe('withTimeTravel', () => {
    ...
    it('should track state changes in history', () => {
      ...
      tree((state: TestState) => ({ ...state, count: 1 }));
      tree((state: TestState) => ({ ...state, count: 2 }));
    ...
    it('should support undo operations', () => {
      ...
      tree((state: TestState) => ({ ...state, count: 1 }));
      tree((state: TestState) => ({ ...state, count: 2 }));
      tree((state: TestState) => ({ ...state, count: 3 }));
    ...
    it('should respect max history size', () => {
      ...
      tree((state: TestState) => ({ ...state, count: 2 }));
      tree((state: TestState) => ({ ...state, count: 3 }));
      tree((state: TestState) => ({ ...state, count: 4 }));
    ...
    it('should handle branching history correctly', () => {
      ...
      tree((state: TestState) => ({ ...state, count: 10 }));
    ...
    it('should not track identical state changes', () => {
      ...
      tree((state: TestState) => ({ ...state, count: currentCount })); // Same value
  ...
  describe('edge cases', () => {
    ...
    it('should handle multiple rapid updates', () => {
      ...
      for (let i = 1; i <= 10; i++) {
        tree((state: TestState) => ({ ...state, count: i }));
      }
