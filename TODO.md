...
| **Scope B — the architecture** | position-attributed transactional history. **Not started.** 15.0.0+                           |
...
on branch `feat/position-attributed-history`, targeting **15.0.0**. It supersedes the
