...
interface BenchmarkResults {
  ...
  effects: {
    singleEffect: number;
    multipleEffects: number;
    conditionalEffect: number;
  };
}
  ...
  template: `
    <div class="metrics-container">
      ...
      <div class="results-grid">
            ...
            <div class="bar-chart">
              ...
              <div class="bar-item">
                ...
                <div class="bar-wrapper">
                  ...
                  ></div>
                  <span class="bar-value">{{ item.value.toFixed(3) }}ms</span>
                </div>
              </div>
              }
            </div>
        ...
        <!-- Effect Performance -->
        <div class="metric-card">
          <h2>🔄 Effect Performance</h2>
          <div class="effects-grid">
            <div class="effect-item">
              <span class="effect-label">Single Effect</span>
              <span class="effect-value"
                >{{ data.effects.singleEffect.toFixed(3) }}ms</span
              >
            </div>
            <div class="effect-item">
              <span class="effect-label">Multiple Effects</span>
              <span class="effect-value"
                >{{ data.effects.multipleEffects.toFixed(3) }}ms</span
              >
            </div>
            <div class="effect-item">
              <span class="effect-label">Conditional Effect</span>
              <span class="effect-value"
                >{{ data.effects.conditionalEffect.toFixed(3) }}ms</span
              >
            </div>
          </div>
        </div>
          ...
          <div class="comparison-grid">
            ...
            <div class="comparison-row">
              ...
              <span
                ...
                [class]="
                  getAdvantageClass(
                    comparison.signalTree.init / comparison.nativeSignals.init
                  )
                "
              >
                {{
            ...
            <div class="comparison-row">
              ...
              <span>{{ comparison.nativeSignals.update.toFixed(3) }}ms</span>
              <span
                class="advantage"
                [class]="
                  getAdvantageClass(
            ...
            <div class="comparison-row">
              ...
              <span>{{ formatMemory(comparison.nativeSignals.memory) }}</span>
              <span
                class="advantage"
                [class]="
                  getAdvantageClass(
...
export class MetricsComponent implements OnInit {
  ...
  async runBenchmarks() {
    ...
    try {
      // Run core benchmarks
      const report = await this.benchmarkService.runFullBenchmark();
      this.results.set(report.metrics);
